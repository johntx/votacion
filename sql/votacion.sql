...
MySQL - 10.4.28-MariaDB : Database - votacion
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`votacion` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
(10,'Libertador General Bernardo O\'Higgins'),
(11,'Maule'),
(12,'Ñuble'),
(13,'Biobío'),
(14,'La Araucanía'),
(15,'Los Ríos'),
(16,'Los Lagos'),
(17,'Aysén del General Carlos Ibáñez del Campo'),
(18,'Magallanes y de la Antártica Chilena');
...
CREATE TABLE `votos` (
  ...
  `comoSeEntero` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `rut` (`rut`)
...
insert  into `votos`(`id`,`nombreApellido`,`rut`,`email`,`alias`,`region`,`comuna`,`candidato`,`comoSeEntero`) values 
(1,'john franco','12958508-0','john@gmail.com','John32','2','7','Candidato 1','RedesSociales,Amigo');
